    ...
    public class QuestionsSqlDao : IQuestionsDao
    {
        ...
        public Question GetQuestion(int id)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT question_id, user_id, question, answer FROM questions WHERE question_id = @questionId", conn);
        ...
        public Question AddQuestion(Question question)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO questions (user_id, question, answer) VALUES (@userId, @question, @answer)", conn);
