<template>
  <main>
    ...
    <section id="addReviewSection" v-if="showAddReview">  <!-- could also v-show to include in the DOM-->
      <form>
        ...
        <div class="form-element">
            ...
            <input id="title" type="text" v-model.lazy="newReview.title" />
        </div>
        <div class="form-element">
...
export default {
  ...
  methods: {
    ...
    addNewReviewRevised(){
      console.log('Add new review revised')
